const data = {
	products: [
		...
		{
			_id: "13",
			name: "Razer Seiren Mini USB Streaming Microphon",
			category: "Oprema",
		...
		{
			_id: "14",
			name: "Klipsch Cinema 400 Sound Bar",
			category: "Slušalice",
		...
		{
			_id: "16",
			name: "Incase Slip MacBook Sleeve (13-inch)",
			category: "Oprema",
		...
		{
			_id: "17",
			name: "Coral 3-in-1 UV Sterilizer and Dryer",
			category: "Oprema",
